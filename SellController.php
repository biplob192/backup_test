...
class SellController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            // Add search conditions for IMEI
            // if (request()->has('search_value') && request()->input('search_value') != '') {
            //     $search_value = request()->input('search_value');
            //     $sells->where(function ($query) use ($search_value) {
            //         $query->where('product_imeis.imei_1', 'like', "%$search_value%")
            //             ->orWhere('product_imeis.imei_2', 'like', "%$search_value%");
            //     });
            // }
