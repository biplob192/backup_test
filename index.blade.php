    ...
    sell_table = $('#sell_table').DataTable({
        ...
        "ajax": {
            ...
            "data": function ( d ) {
                ...
                // Send the search query along with the ajax request
                if ($('#sell_table_filter input[type="search"]').val()) {
                    d.search_value = $('#sell_table_filter input[type="search"]').val();
                }
        ...
        columns: [
            ...
            { data: 'imei_1', name: 'imei_1', visible: true, searchable: true },
            { data: 'imei_2', name: 'imei_2', visible: true, searchable: true },
